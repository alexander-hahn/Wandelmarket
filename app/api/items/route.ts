...
export async function POST(req: NextRequest) {
  ...
  const item = await prisma.shopItem.create({
    data: {
      ...
      compatibilityAppVersions: JSON.stringify(Array.isArray(compatibilityAppVersions) ? compatibilityAppVersions : []),
      compatibilityToolchain: JSON.stringify(Array.isArray(compatibilityToolchain) ? compatibilityToolchain : []),
